...
import com.FMeneguzzi.demo_park.api.service.ClienteVagaService;
import com.FMeneguzzi.demo_park.api.service.EstacionamentoService;
import com.FMeneguzzi.demo_park.api.service.JasperService;
...
import com.FMeneguzzi.demo_park.api.web.dto.mapper.ClienteVagaMapper;
...
public class EstacionamentoController {
   ...
   // @PreAuthorize("hasRole('ADMIN')")
    ...
    @GetMapping("/cpf/{cpf}")
    //@PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<PagebleDto> getAllEstacionamentosPorCpf(@PathVariable String cpf, @Parameter(hidden = true)
    @PageableDefault(size = 5, sort = "dataEntrada",
        ...
        PagebleDto dto = PageableMapper.toDto(projection);
        return ResponseEntity.ok(dto);
    }
    ...
    public ResponseEntity<PagebleDto> getAllEstacionamentosDoCliente(@AuthenticationPrincipal JwtUserDetails user,
