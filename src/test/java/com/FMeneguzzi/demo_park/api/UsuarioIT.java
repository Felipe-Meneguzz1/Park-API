...
public class UsuarioIT {
    ...
    public void listarUsuarios_ComUsuarioSemPermissao_RetornarErrorMessageComStatus403() {
        ErrorMessage responseBody = testClient
                .get()
                .uri("/api/v1/users")
                .headers(JwtAuthentication.getHeaderAuthorization(testClient, "usuario_sem_permissao@email.com", "123456"))
                .exchange()
    ...
    public void editarSenha_ComCamposInvalidos_RetornarErrorMessageComStatus422() {
        ...
        responseBody = testClient
                ...
                .uri("/api/v1/usuarios/100")
                .contentType(MediaType.APPLICATION_JSON)
                .bodyValue(new UserSenhaDto("12345678", "12345678", "12345678"))
                .exchange()
                .expectStatus().isEqualTo(422)
                .expectBody(ErrorMessage.class)
                .returnResult().getResponseBody();
